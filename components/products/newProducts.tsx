  ...
  return (
    <div className="py-[0.5rem] ">
      ...
      return(
                  ...
                  <div className="w-[0.8rem] h-[0.8rem] border-[1px] border-gray-300" key={index} style={{backgroundColor:`${item.hex}`}}></div>
        ...
        <Link key={product._id} href={`/product/${product._id}`} className="no-underline  py-[2rem] w-full flex gap-[1rem]">
               {product.mainImage && <img src={product.mainImage} alt={product.name} width={150} className="h-auto w-[50%] "/>}
