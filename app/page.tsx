...
function Page(){
  ...
  return (
  <main>
    <div className=" h-screen w-full relative flex items-center justify-center flex-col bg-[#f2f2f2] gap-[2rem]">
        <p className=" text-center text-[2.5rem] " ><span className="block text-[3rem] sm:text-[4rem]  leading-none "><br/>SALE</span>UP TO 50% OFF</p>
